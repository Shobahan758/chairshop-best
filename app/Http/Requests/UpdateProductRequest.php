...
class UpdateProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'slug' => ['required', 'string', 'alpha_dash', 'max:255', Rule::unique('products', 'slug')->ignore($product)],
            ...
            'additional_images.*' => ['nullable', 'image', 'mimes:jpg,jpeg,png,webp', 'max:20480'],
    ...
    protected function prepareForValidation(): void
    {
        ...
        if ($this->filled('discount_percentage') && is_numeric($this->input('price')) && is_numeric($this->input('discount_percentage'))) {
            ...
            $attributes['sale_price'] = $discountPercentage > 0 ? round($price * (1 - ($discountPercentage / 100)), 2) : null;
        }
